...
public class PruebaAeronave12 {
    ...
    public void step() {
		...
		if ((a != null) && (pos != null)) 
			a.mover(pos, time);
		rp.setAeronaves(Arrays.asList(new Aeronave[] {a}));
		rp.repaint();    	
    }	
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                PruebaAeronave12 pva = new PruebaAeronave12();
                pva.init();
    ...
    private void createAndShowGUI() {
        ...
        this.rp.addMouseListener(new MouseAdapter() {
             public void mouseClicked(MouseEvent e) {
            	...
            	pos = new Vector((e.getX() - 400),(300 - e.getY()),lastHeight);
            	if (a == null)
            		a = new Aeronave ("AUTO" + time, pos, time, pos, time);
            }
        });
